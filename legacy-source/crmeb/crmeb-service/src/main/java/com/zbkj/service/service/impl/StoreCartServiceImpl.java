...
public class StoreCartServiceImpl extends ServiceImpl<StoreCartDao, StoreCart> implements StoreCartService {
    ...
    public PageInfo<CartInfoResponse> getList(PageParamRequest pageParamRequest, boolean isValid) {
        ...
        for (StoreCart storeCart : storeCarts) {
            ...
            List<StoreProductAttrValue> attrValueList = storeProductAttrValueService
                    .getListByProductIdAndAttrId(storeCart.getProductId(),
    ...
    public String saveCate(CartRequest storeCartRequest) {
        ...
        List<StoreProductAttrValue> attrValues = storeProductAttrValueService
                .getListByProductIdAndAttrId(product.getId(), storeCartRequest.getProductAttrUnique(), Constants.PRODUCT_TYPE_NORMAL);
