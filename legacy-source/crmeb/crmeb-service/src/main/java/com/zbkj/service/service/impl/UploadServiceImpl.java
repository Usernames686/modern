...
public class UploadServiceImpl implements UploadService {
    ...
    private String uploadValidate(String fileName, float fileSize, String fileType, String contentType) {
        ...
        String extStr = systemConfigService.getValueByKey(fileType.equals(UploadConstants.UPLOAD_AFTER_FILE_KEYWORD) ?
                SysConfigConstants.UPLOAD_FILE_EXT_STR_CONFIG_KEY : SysConfigConstants.UPLOAD_IMAGE_EXT_STR_CONFIG_KEY);
        // 判断文件的后缀名是否符合规则
        ...
        // 文件大小验证
        int size = Integer.parseInt(systemConfigService.getValueByKey(fileType.equals(UploadConstants.UPLOAD_AFTER_FILE_KEYWORD) ?
                SysConfigConstants.UPLOAD_FILE_MAX_SIZE_CONFIG_KEY : SysConfigConstants.UPLOAD_IMAGE_MAX_SIZE_CONFIG_KEY));
    ...
    private FileResultVo commonUpload(MultipartFile multipartFile, String model, Integer pid, String fileType) throws IOException {
        ...
        // 类型
        String type = (fileType.equals(UploadConstants.UPLOAD_FILE_KEYWORD) ?
                UploadConstants.UPLOAD_FILE_KEYWORD : UploadConstants.UPLOAD_AFTER_FILE_KEYWORD) + "/";
        // 变更文件名
            ...
            case 4:
                ...
                try {
                    ...
                    cosService.uploadFile(cloudVo, systemAttachment.getSattDir(),
                            ...
                            systemAttachment.getAttId(), cosClient);
                } catch (Exception e) {
