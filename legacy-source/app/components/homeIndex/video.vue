<template>
	<view>
		<view class="diy_video acea-row row-center-wrapper" :style="[boxStyle]">
			<video :style="[contantRadius]" :src="link" :show-mute-btn="pageGesture" :poster="cover" controls
				:autoplay="false" loop objectFit="cover"></video>
		</view>
	</view>
</template>
<script>
	export default {
		...
		computed: {
			...
			contantRadius() {
				return {
					'border-radius': this.dataConfig.contantStyle.val ? this.dataConfig.contantStyle.val + 'px' : '0'
				};
			},
		}
	}
