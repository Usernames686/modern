					...
					<view class="head pad30">
						<view class="user-card">
							<view class="user-info" @click="goEdit()">
								...
								<image v-else class="avatar" :src="urlDomain+'crmebimage/perset/staticImg/f.png'"
									mode=""></image>
								<view class="info">
									...
									<view class="num" v-if="userInfo && userInfo.phone && uid">
										...
										<view class="icon">
											<image :src="urlDomain+'crmebimage/perset/staticImg/edit.png'" mode="">
											</image>
										</view>
									</view>
									<view class="phone" v-if="!userInfo.phone && isLogin" @tap.stop="bindPhone">绑定手机号
									</view>
									<!-- #ifdef APP-PLUS -->
