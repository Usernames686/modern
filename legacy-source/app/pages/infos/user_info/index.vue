					...
					<view class='item acea-row row-between-wrapper'>
						...
						<navigator url="/pages/infos/user_phone/index" hover-class="none" class="input" v-else>
							<view class='input acea-row row-between-wrapper'>
								<input disabled='true' name='phone' :value='userInfo.phone' class='id'></input>
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			this.newAvatar = this.userInfo.avatar ? this.userInfo.avatar :
				`${this.$Cache.get("imgHost")}crmebimage/perset/staticImg/f.png`;
