			...
			<view class='wrapper'>
				<view :hidden='currentTab != 0' class='list'>
					<form @submit="subCash" report-submit='true'>
						...
						<view class='tip'>
							当前可提现金额: <text
								class="price">￥{{commission.commissionCount}},</text>冻结佣金：￥{{commission.brokenCommission}}
						</view>
						<view class='tip'>
				...
				<view :hidden='currentTab != 1' class='list'>
					<form @submit="subCash" report-submit='true'>
						...
						<view class='item acea-row row-between-wrapper'>
							<view class='name'>提现</view>
							<view class='input'>
								<input :placeholder='"最低提现金额"+minPrice' placeholder-class='placeholder' name="money"
									type='digit' maxlength="5" />
							</view>
						</view>
