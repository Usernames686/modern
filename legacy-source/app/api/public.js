...
export function imageBase64(image) {
	return request.post("qrcode/base64", image, {
		noAuth: true
	}, 1);
}
...
export function appAuth(data) {
	return request.post("wechat/authorize/app/login", data, {
		noAuth: true
	});
}
...
export function iosBinding(data) {
	return request.post("ios/binding/phone", data, {
		noAuth: true
	});
}
/**
...
export function iosRegisterBinding(data) {
	return request.post("ios/register/binding/phone", data, {
		noAuth: true
	});
}
