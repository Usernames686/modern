...
export function tokenIsExistApi() {
	return request.post(`token/is/exist`, {}, {
		noAuth: true
	});
}
...
export function getBottomNavigationApi() {
	return request.get(`get/bottom/navigation`, {}, {
		noAuth: true
	});
}
/**
...
export function pagediyInfoApi(id) {
	return request.get(`pagediy/info/${id}`, {}, {
		noAuth: true
	});
}
/**
...
export function getCategoryTwo(id) {
	return request.get(`categorybypid/${id}`, {}, {
		noAuth: true
	});
}
/**
...
export function getConfigCopyright(id) {
	return request.get(`config/get/copyright`, {}, {
		noAuth: true
	}, {}, true);
}