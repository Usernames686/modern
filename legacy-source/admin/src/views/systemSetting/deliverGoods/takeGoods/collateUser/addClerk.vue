  ...
  >
    ...
    >
      <el-form-item label="管理员：" prop="uid">
        ...
        <el-button class="ml10" type="primary" size="small" @click="upImg">选择管理员</el-button>
      </el-form-item>
      <el-form-item label="所属提货点：" prop="storeId">
        <el-select v-model="ruleForm.storeId" placeholder="请选择" style="width: 100%" clearable>
    ...
    <customer-info class="list-Dialog" ref="customer" @upImgUid="upImgUid"></customer-info>
  </el-dialog>
</template>
