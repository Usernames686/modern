  ...
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <el-button type="primary" class="mr10" @click="add" v-hasPermi="['admin:system:user:level:save']"
          >添加用户等级</el-button
        >
      </div>
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="mini">
        ...
        <el-table-column label="操作" width="120" fixed="right">
          <template slot-scope="scope">
            ...
            <a @click="handleDelete(scope.row.id, scope.$index)" v-hasPermi="['admin:system:user:level:delete']"
              >删除</a
            >
          </template>
        </el-table-column>
