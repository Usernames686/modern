<template>
  <el-form :model="ruleForm" ref="ruleForm" label-width="0" class="demo-ruleForm">
    ...
    <el-form-item label="用户等级：" label-width="72px">
      <el-select style="width: 100%" v-model="ruleForm.levelId" clearable placeholder="请选择" @change="currentSel">
        <el-option
    ...
    <el-form-item label="扣除经验：" label-width="72px" v-if="grade == '' ? false : grade < levelInfo.gradeLevel">
