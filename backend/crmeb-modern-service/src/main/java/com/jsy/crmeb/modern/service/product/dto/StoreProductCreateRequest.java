...
public class StoreProductCreateRequest extends StoreProductBasicUpdateRequest {
    ...
    public List<String> getSliderImages() { return sliderImages; }
    public void setSliderImages(List<String> sliderImages) { this.sliderImages = sliderImages; }
    ...
    public Integer getGiveIntegral() { return giveIntegral; }
    ...
    public Integer getFicti() { return ficti; }
    public void setFicti(Integer ficti) { this.ficti = ficti; }
    ...
    public Boolean getIsBenefit() { return isBenefit; }
    public void setIsBenefit(Boolean isBenefit) { this.isBenefit = isBenefit; }
