...
public class UserBrokerageRecord {
    ...
    public Integer getBrokerageLevel() { return brokerageLevel; }
    public void setBrokerageLevel(Integer brokerageLevel) { this.brokerageLevel = brokerageLevel; }
}
